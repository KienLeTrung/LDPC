...
%        p_channel((2*Z+1):(size(v,2)-no_punctured_columns*Z))=r;
%        p_channel_fixed=int16(round(p_channel*2^7));     %fixed point 9_7    
  % [p_channel]=ML(r,size(v,2),no_punctured_columns,Z);
  
[p_channel]=ML(r,no_punctured_columns,Z);
